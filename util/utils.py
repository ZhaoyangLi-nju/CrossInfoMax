...
def cal_mean_acc(cfg, data_loader, pred_index_all, target_index_all):
    result = mean_acc(np.array(target_index_all), np.array(pred_index_all),
                             cfg.NUM_CLASSES,
...
def save_numpy_image(path, data):
